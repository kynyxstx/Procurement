            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <select wire:model.live="filterSupplier"
                                    ...
                                    <option value=""
                                        style="color: #ffffff; font-weight: bold; background-color: #636363;">
                                        All Supplier
                                    </option>
                                    <option
                                    ...
                                    <option
                                        value="IJA Enterprises;Trainosys Training Services;Kaifashion Philippines Inc.">
                    ...
                    <div class="p-10 w-full">
                        <h1 style="font-size: 2em;">Supplier Directory List</h1><br>
                                ...
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 cursor-pointer whitespace-nowrap"
                                            ...
                                            <span class="text-lg font-semibold">Supplier Name</span>
                                        ...
                                        <th class="px-6 py-3 cursor-pointer whitespace-nowrap"
                                            ...
                                            <span class="text-lg font-semibold">Contact Person</span>
                                        ...
                                        <th class="px-6 py-3 cursor-pointer whitespace-nowrap"
                                            ...
                                            <span class="text-lg font-semibold">Mobile No.</span>
                                        ...
                                        <th class="px-6 py-3 cursor-pointer whitespace-nowrap"
                                            ...
                                            <span class="text-lg font-semibold">Telephone No.</span>
                            ...
                            <div class="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow-lg max-w-lg w-full mx-auto">
                                ...
                                <div>
                                    <form wire:submit.prevent="saveSupplier">
                                        ...
                                        <div class="mb-3">
                                            <label for="items"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Items
                                                Supplied</label>
                                    ...
                                    <form wire:submit.prevent="saveSupplier">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea wire:model="items" id="editItems" placeholder="Enter Items"
                                                class="w-full mt-1 p-2 border rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 text-base sm:text-lg"></textarea>
                                            @error('items') <span
                                                class="text-red-500 text-xs">{{ $errors->first('items') }}</span>
                                            @enderror
                                        </div>
