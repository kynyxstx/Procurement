<div class="flex flex-col items-center p-10">
    ...
    <div class="p-10 w-full overflow-x-auto">
        <div
            class="w-full flex flex-wrap justify-between items-center space-y-2 md:space-y-0 md:flex-nowrap md:space-x-4 mb-6">
            <select wire:model="filterSupplier" wire:change="performSearch"
                class="p-2 border rounded-md shadow-md min-w-[250px]">
            ...
            <button wire:click="exportToPDF"
                class="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-700 focus:outline-none focus:ring focus:border-red-300">
                Export to PDF
            </button>
