            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="w-full flex justify-between items-center mb-4 pl-10">
                        ...
                        <div class="flex items-center space-x-4 p-10 mt-10">
                            <button wire:click="exportToExcel"
                                class="px-5 py-2 bg-green-500 text-white rounded-lg hover:bg-green-700">
                                Export to Excel
                            </button>
                                ...
                                @if ($monitorings->isNotEmpty())
                                    @foreach ($monitorings as $monitoring)
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="py-2 px-4 border break-words">{{ $monitoring->date_endorsement }}
                                            </td>
